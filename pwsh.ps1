...
function sync_art { Param($arg) unison -batch $arg $HOME\Pictures\Art ssh://zazag@192.168.0.17/Pictures/Art }
function sync_music { Param($arg) unison -batch $arg $HOME\Music ssh://zazag@192.168.0.17/Music }
